...
public class Level4Controller : MonoBehaviour {
    ...
    void Start()
    {
        StartCoroutine(Level4Control());
    }

    IEnumerator Level4Control()
    {
        //단계1
        ...
        yield return new WaitForSeconds(1.5f);
        instance2 = Instantiate(Enemy2, Generatepos2_2.position, Generatepos2_2.rotation);
        yield return new WaitForSeconds(1.5f);
        instance3 = Instantiate(Enemy3, Generatepos2_3.position, Generatepos2_3.rotation);
        yield return new WaitForSeconds(5f);

        //단계3
        instance3 = Instantiate(Enemy3, Generatepos3_1.position, Generatepos3_1.rotation);
        yield return new WaitForSeconds(1.5f);
        instance3 = Instantiate(Enemy3, Generatepos3_2.position, Generatepos3_2.rotation);
        yield return new WaitForSeconds(1.5f);
